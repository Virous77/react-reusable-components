...
const RRCSelect: React.FC<TRRCSelect> = (props) => {
          ...
          >
            ...
            {group.data?.map((item) => (
              <SelectItem
                ...
                key={item.value}
                value={item.value}
                className={cn(props.classNames?.item)}
              >
                {item.name}
              </SelectItem>
            ))}
  ...
  return (
    ...
    >
      <SelectTrigger
        className={cn("w-[180px]", props.classNames?.trigger)}
      ...
      <SelectContent
        ...
        className={cn(props.classNames?.content)}
      >
        {props.isGrouped
